...
Official implementation (PyTorch + [SpikingJelly](https://github.com/fangwei123456/spikingjelly)) for skeleton-based action recognition with **1D-SGC**, **FSC**, and **MWTF** modules.

> 基于脉冲图卷积与时空–频域动力学的骨骼动作识别；本仓库为论文对应代码实现，便于复现与二次开发。
